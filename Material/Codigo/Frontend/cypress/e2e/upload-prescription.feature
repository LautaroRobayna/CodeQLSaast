...
Scenario: Subida de receta luego de creación de la reserva
    Given existe una reserva en estado "Pendiente" con clave pública "CLAVE-PUBLICA-TEST" y fecha de expiración "2026-06-15"
    And el cliente visita la página "/reservations"
    And ingresa la clave pública "CLAVE-PUBLICA-TEST" en el campo "#public-key-input"
    And hace clic en "#btn-buscar-reserva"
    When arrastra el archivo "receta_medica_2026.pdf" al elemento input "#file-receta-post"
    And hace clic en el botón "#btn-subir-receta"
    Then el indicador de receta debe decir "Receta: Presentada - Pendiente de Validación"
